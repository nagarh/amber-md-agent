...
Real simulations run end-to-end by this agent — one per biomolecular class, drawn from the [benchmark](Benchmark/). Every number below is traceable to that study's final report:
