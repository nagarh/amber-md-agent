#!/bin/bash
#SBATCH -D /home/hn533621/Portfolio/amber-md-agent-improvements/studies/ABL1_T315I_imatinib_TI/simulations/ti_apo
#SBATCH --job-name=ti_apo_abl1
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-10
#SBATCH --output=ti_apo_abl1_%A_%a.out
#SBATCH --error=ti_apo_abl1_%A_%a.err
...
cd ${STUDY}/simulations/ti_apo/lambda_${LAMBDA}
