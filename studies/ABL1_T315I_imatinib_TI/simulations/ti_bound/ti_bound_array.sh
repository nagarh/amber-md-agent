#!/bin/bash
#SBATCH -D /home/hn533621/Portfolio/amber-md-agent-improvements/studies/ABL1_T315I_imatinib_TI/simulations/ti_bound
#SBATCH --job-name=ti_bound_abl1
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-10
#SBATCH --output=ti_bound_abl1_%A_%a.out
#SBATCH --error=ti_bound_abl1_%A_%a.err
...
cd ${STUDY}/simulations/ti_bound/lambda_${LAMBDA}
PRMTOP=${STUDY}/system/ti_merged_bound.prmtop
REFCRD=${STUDY}/simulations/preequil/equil.rst7
# Per-window equilibration (1 ns, start from pre-equil)
