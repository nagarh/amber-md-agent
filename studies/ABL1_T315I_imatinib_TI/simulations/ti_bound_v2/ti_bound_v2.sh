#!/bin/bash
#SBATCH -D /home/hn533621/Portfolio/amber-md-agent-improvements/studies/ABL1_T315I_imatinib_TI/simulations/ti_bound_v2
#SBATCH --job-name=ti_bound_v2
...
#SBATCH --gres=gpu:1
#SBATCH --array=0-10
#SBATCH --output=ti_bound_v2_%A_%a.out
#SBATCH --error=ti_bound_v2_%A_%a.err
...
cd ${STUDY}/simulations/ti_bound_v2/lambda_${LAMBDA}
