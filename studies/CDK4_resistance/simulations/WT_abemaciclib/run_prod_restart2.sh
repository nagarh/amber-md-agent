...
#SBATCH --output=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/WT_abemaciclib/CDK4_WT_abema_prod2_%j.out
#SBATCH --error=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/WT_abemaciclib/CDK4_WT_abema_prod2_%j.err
...
echo "=== Equil2: 1 ns unrestrained NPT with pmemd.cuda (Berendsen barostat for density convergence) ==="
pmemd.cuda -O \
  -i  $MDIN/equil2.mdin \
