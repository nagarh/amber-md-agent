#!/bin/bash
#SBATCH --job-name=CDK4_WT_atirmo
#SBATCH --output=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/WT_atirmociclib/CDK4_WT_atirmo_%j.out
#SBATCH --error=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/WT_atirmociclib/CDK4_WT_atirmo_%j.err
...
#SBATCH -D /home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/WT_atirmociclib

module load amber/24
source /opt/shared/apps/amber/24/amber.sh

SYS=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/system/WT_atirmociclib
MDIN=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/mdin
SIMDIR=/home/hn533621/Portfolio/amber-md-agent/studies/CDK4_resistance/simulations/WT_atirmociclib
...
echo "=== Pipeline complete: WT+atirmociclib ==="
