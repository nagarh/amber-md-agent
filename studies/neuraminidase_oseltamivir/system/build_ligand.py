...
RESNAME   = "G39"
PDB_PATH  = "studies/neuraminidase_oseltamivir/raw_pdbs/6HEB_chainA.pdb"
DRUG_NAME = "oseltamivir carboxylate"
OUT_SDF   = "studies/neuraminidase_oseltamivir/system/ligand_ready.sdf"
...
if unmatched:
    print(f"WARNING: {len(unmatched)} unmatched atoms — placing from ideal/neighbor geometry")
    try:
