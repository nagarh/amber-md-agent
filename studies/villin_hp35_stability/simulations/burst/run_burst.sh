...
#SBATCH -D /home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst
#SBATCH --output=/home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/burst_villin_%j.out
#SBATCH --error=/home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/burst_villin_%j.err

module load gnu12/12.2.0
module load amber/24
source /opt/shared/apps/amber/24/amber.sh

mkdir -p /home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst

echo "=== Density convergence: pmemd.cuda restart loop "
echo "    target 1.000 +/- 0.050 g/cc, fluctuation < 0.020"

RST_IN=/home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/heat/heat.rst7
MAX_ITER=30
TARGET=1.0
TOL=0.05
FLUCT_MAX=0.02
...
while [ $iter -lt $MAX_ITER ]; do
    OUT=/home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/density_r${iter}.mdout
    RST_OUT=/home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/density_r${iter}.rst7

    pmemd.cuda -O \
      -i  /home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/equil_density_burst.mdin \
      -o  $OUT \
    ...
    if [ -f "$RST_OUT" ]; then
        ...
        if [ $exit_code -eq 0 ] && [ "$STATUS" = "YES" ]; then
            ...
            cp $RST_OUT /home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/burst_final.rst7
            break
...
if [ ! -f "/home/hn533621/Portfolio/amber-md-agent/studies/villin_hp35_stability/simulations/burst/burst_final.rst7" ]; then
